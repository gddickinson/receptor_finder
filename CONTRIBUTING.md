# Contributing to receptor_finder
...
[GitHub issue](https://github.com/gddickinson/receptor_finder/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the proteome you screened, and whether the failure was in the AlphaFold step, the docking step, or scoring.
